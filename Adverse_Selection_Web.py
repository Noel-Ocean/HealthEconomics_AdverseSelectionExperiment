...
st.sidebar.write("**Source code**: https://github.com/Noel-Ocean/HealthEconomics_AdverseSelectionExperiment")
...
# web body - C
    ...
    Gold_plan=st.multiselect('Gold (C1="Character1")', options=Gold_list, default=Gold_list)
