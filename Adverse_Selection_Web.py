...
st.sidebar.writer("**Web app developer source code (Python) on GitHub**: https://raw.githubusercontent.com/Noel-Ocean/HealthEconomics_AdverseSelectionExperiment/main/Adverse_Selection_Web.py")
