...
st.sidebar.write("**Developer note**: This web app is developed with Python and Streamlit | Source code: https://github.com/Noel-Ocean/HealthEconomics_AdverseSelectionExperiment")
